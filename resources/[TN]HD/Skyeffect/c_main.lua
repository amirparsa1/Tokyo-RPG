...
local dynamicSkySettings = {
		...
		modelScale = {0.125, 0.125, 0.125}, -- skydome scale (multiply in shader)
		origSizeMul = 10, -- sphere object scale (divide in shader)
...
function startDynamicSky()
	...
	shaderTable.skyboxTropos = dxCreateShader ( "Skyeffect/fx/shader_dynamicSky2tropos.fx", 2, 0, false, "object" )
	if dynamicSkySettings.stratosBottomStars then shaderTable.skyboxStratos = dxCreateShader ( "fx/shader_dynamicSky2up.fx", 2, 0, false, "object" ) 
	    else shaderTable.skyboxStratos = dxCreateShader ( "Skyeffect/fx/shader_dynamicSky2stratos.fx", 2, 0, false, "object" ) end
	if dynamicSkySettings.stratosBottomStars then shaderTable.skyboxBottom = dxCreateShader ( "Skyeffect/fx/shader_dynamicSky2down.fx", 3, 0, false, "object" )
		else shaderTable.skyboxBottom = dxCreateShader ( "Skyeffect/fx/shader_dynamicSky2bottom.fx", 3, 0, false, "object" ) end
	shaderTable.clear = dxCreateShader ( "Skyeffect/fx/shader_clear.fx", 3, 0, false, "world" )
	textureTable.cloud = dxCreateTexture ( "Skyeffect/tex/clouds.dds", "dxt5" )
	textureTable.normal = dxCreateTexture ( "Skyeffect/tex/clouds_normal.jpg", "dxt5" ) 
	textureTable.skybox = dxCreateTexture ( "Skyeffect/tex/skybox.dds", "dxt5" )
	moonPhase = getCurrentMoonPhase()
	textureTable.moon = dxCreateTexture ( "Skyeffect/tex/moon/"..toint( 20 - toint( moonPhase * 20 ) )..".png" )
	...
	dxSetShaderValue ( shaderTable.skyboxTropos, "gScale", dynamicSkySettings.modelScale[1] / dynamicSkySettings.origSizeMul, 
		dynamicSkySettings.modelScale[2] / dynamicSkySettings.origSizeMul, dynamicSkySettings.modelScale[3] / dynamicSkySettings.origSizeMul )
	...
	dxSetShaderValue ( shaderTable.skyboxStratos, "gScale", dynamicSkySettings.modelScale[1] / dynamicSkySettings.origSizeMul, 
		dynamicSkySettings.modelScale[2] / dynamicSkySettings.origSizeMul, dynamicSkySettings.modelScale[3] / dynamicSkySettings.origSizeMul )
	...
	if dynamicSkySettings.stratosBottomStars then dxSetShaderValue ( shaderTable.skyboxBottom, "sCubeTex", textureTable.skybox ) end
	...
	dxSetShaderValue ( shaderTable.skyboxBottom, "gScale", dynamicSkySettings.modelScale[1] / dynamicSkySettings.origSizeMul, 
		dynamicSkySettings.modelScale[2] / dynamicSkySettings.origSizeMul, dynamicSkySettings.modelScale[3] / dynamicSkySettings.origSizeMul )
	...
	modelTable.txd = engineLoadTXD( 'Skyeffect/tex/skybox_model.txd' )
	engineImportTXD( modelTable.txd, dynamicSkySettings.modelID)
	modelTable.dff = engineLoadDFF( 'Skyeffect/dff/skybox_model.dff', dynamicSkySettings.modelID )
	...
	setObjectScale( modelTable.object, 8 * dynamicSkySettings.origSizeMul, 8 * dynamicSkySettings.origSizeMul, 8 * dynamicSkySettings.origSizeMul)
