...
function()
	...
	outputChatBox("getting fps...")
	setTimer(function() 
	outputChatBox("#ffffff FPS Shoma Dar In Lahze: #e435f2"..math.ceil(fps),25,255,25,true)
	addEventHandler("onClientPreRender", root, updateFPS) end,1000,1)
