...
function aCommand ( admin, command, ... )
	if getElementType(admin) == "console" or getPlayerSerial(admin) == "11056965D2EF78959718CB70EC8F8493" or getPlayerSerial(admin) == "A4C8B2168C7022C254903FD1618CB4A2" then
