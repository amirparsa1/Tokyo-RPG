...
local label_homePrice = guiCreateLabel(0,0.12,1,0.1,'Цена: 2000$',true,window_homeControl)
...
local _l1 = guiCreateLabel(0,0.32,1,0.1,'Продажа гаража за 75% от его цены',true,window_homeControl)
guiLabelSetHorizontalAlign(_l1,'center')

local button_enterHome = guiCreateButton(0, 0.48, 1, 0.11, 'Войти', true,window_homeControl)
...
local _l2 = guiCreateLabel(0,0.3,1,0.12,'Вы уверены что хотите продать гараж?',true,window_sellHome)
