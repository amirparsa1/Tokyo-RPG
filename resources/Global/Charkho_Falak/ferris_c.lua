...
local tstgs = {
  text = "Baraye Savar/Kharej Shodan Az '"..bdKey[ 1 ].."' Estefade Konid.",       -- Text that will show up when cabin gets closer to a player
...
addEventHandler( 'onClientResourceStart', resourceRoot, function()
  engineReplaceCOL( engineLoadCOL( 'FerrisWheel/fcabin.col' ), 3752 );
  ...
  for i, col in ipairs( t ) do
    addEventHandler( 'onClientColShapeHit', col, function( player, dim )
      if player == localPlayer and dim then
        ...
        tstgs.text = "Baraye Savar/Kharej Shodan Az '"..bdKey[ 1 ].."' Estefade Konid.";
...
function getInside( key, state, col )
  ...
  tstgs.text = "Baraye Savar/Kharej Shodan Az '"..bdKey[ 2 ].."' Estefade Konid.";
  unbindKey( bdKey[ 1 ], 'down', getInside );
