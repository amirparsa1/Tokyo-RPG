...
shootingRangeGunIDs = {}
 ...
 i = i + 1
 shootingRangeGuns["name"][i], shootingRangeGuns["id"][i] = "9mm Silenced", 23
 i = i + 1
 ...
 i = i + 1
 shootingRangeGuns["name"][i], shootingRangeGuns["id"][i] = "Rifle", 33
 i = i + 1
 shootingRangeGuns["name"][i], shootingRangeGuns["id"][i] = "Sniperrifle", 34
