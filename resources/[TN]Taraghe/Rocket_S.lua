...
--[[addCommandHandler("cr2", function(player)
...
function CreateCrClient( player , Type )  
	triggerClientEvent( "playBoom", player, Type )
end

addCommandHandler("cr3", function(player)
	CreateCrClient( player , 1 )
end)
...
--[[addCommandHandler("cr4", function(player)
	CreateCrClient( player , 2 )
end)]]

addCommandHandler("cr5", function(player)
	CreateCrClient( player , 3 )
end)      
maxRockets = 32
command = "cr1"
...
function CreateCrClient( player , Type )  
	triggerClientEvent( "BendazTaragheRe", resourceRoot , player, tonumber(Type) )
end
...
addCommandHandler("cr6", function(player)
	CreateCrClient( player , 4 )
end)      