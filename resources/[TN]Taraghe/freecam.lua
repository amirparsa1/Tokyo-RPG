...
addCommandHandler("freecam", function()
	if tonumber(getElementData(accSys:getPlayerAcc(thePlayer), "pAdmin")) < 9 then
		outputChatBox("#33AA33Error: Motasefane dastresi be in dastoor baraye shoma maghdoor nist.", 255, 255, 255, true)
		return
	end
	if isFreecamEnabled() then
		...
		outputChatBox("#ffffffFree Camera #ff0000Disable #ffffffShod", 255, 255, 255, true)
	else
		setFreecamEnabled()
		toggleAllControls ( false, true, false )
		outputChatBox("#ffffffFree Camera #00ff00Enable #ffffffShod", 255, 255, 255, true)
	end
end)
