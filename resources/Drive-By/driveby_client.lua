...
function doesPlayerHaveWeapon()
	local pedSlot = getPedWeaponSlot ( localPlayer )
		...
		outputChatBox(pedSlot)
	
end
addCommandHandler("weapon", doesPlayerHaveWeapon)
isBike = {[509]=true, [481]=true,[581]=true,[462]=true,[521]=true,[463]=true,[522]=true,[461]=true,[448]=true,[468]=true,[586]=true,[471]=true, [510]=true,[523]=true,[573]=true}
...
function toggleDriveby()
	...
	if isBike[getElementModel(getPedOccupiedVehicle ( localPlayer ))] then return end
			...
			for key,weaponID in ipairs(weaponsTable) do
				...
				if weapon == weaponID then
					...
					if getPedTotalAmmo ( localPlayer, slot ) ~= 0 then
						...
						if not switchTo or slot == 4 or slot == 5 then
							
							switchTo = slot
							switchToWeapon = weaponID
							helpText:text( "Press 'e' or 'q' to change weapon" )
						end
					end
				end
			end
